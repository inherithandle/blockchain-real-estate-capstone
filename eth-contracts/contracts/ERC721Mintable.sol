...
contract Ownable {
    ...
    // a list of modifiers
    modifier onlyOwner() {
        require(msg.sender == _owner, "caller must be a contract owner.");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "you need to transfer a valid address.");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    */
    ...
    // a list of modifiers
    modifier paused() {
        require(_paused,"contract should be in operational state.");
        _;
    }

    modifier whenNotPaused() {
        require(!_paused,"contract should not be in operational state.");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        // require implemented in the ownerOf function.
        address owner = ownerOf(tokenId);

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner,msg.sender), "msg.sender is not authorized.");
...
contract RealEstateERC721Token is ERC721Metadata("House Listing", "DEED", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
